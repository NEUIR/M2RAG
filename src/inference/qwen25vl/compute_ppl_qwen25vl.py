...
from qwen2vl_datasets_modules import make_supervised_data_module, DataArguments
...
def load_model_tokenizer(model_path, args):
    model = Qwen2_5_VLForConditionalGeneration.from_pretrained(model_path, trust_remote_code=True,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--topk', type=int, default=5)  #范围为[0,5]

    args = parser.parse_args()
    data_args = DataArguments()
    #将data_args的属性赋值给args
