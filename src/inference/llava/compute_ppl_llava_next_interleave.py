...
from transformers import LlavaForConditionalGeneration, AutoProcessor, Qwen2VLProcessor, LlavaConfig
from llava_next_datasets_modules import make_supervised_data_module, DataArguments
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path",type=str,default='llava-interleave-qwen-7b-hf')
    parser.add_argument('--data_path',type=str,default='')
    parser.add_argument('--trec_path',type=str,default='')
    parser.add_argument('--image_path',type=str,default='')
    parser.add_argument("--cand_image_map_path", type=str, default=None)
    ...
    for step, inputs in tqdm(enumerate(data_reader), total=total):
        with torch.no_grad():
            ...
            shift_logits = shift_logits.view(-1,
                                        model.config.text_config.vocab_size).contiguous()
