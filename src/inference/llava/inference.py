...
from transformers import AutoProcessor, LlavaForConditionalGeneration       # transformers>=4.51.3
from llava.inference_data_new import load_data,InferenceDataset
import torch
import argparse
import random
import logging
...
from llava.get_prompt_new_after_rm import get_prompt
