...
from transformers import AutoModelForImageTextToText, AutoProcessor, Qwen2VLProcessor, LlavaConfig
from internvl3_datasets_modules import make_supervised_data_module, DataArguments
...
def move_inputs_to_device(inputs, device):
    ...
    inputs['pixel_values'] = inputs['pixel_values'].to(torch.bfloat16).to(device)
